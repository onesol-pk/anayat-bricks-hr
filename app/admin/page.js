...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#061226] text-white lg:flex">
      <aside className="hidden lg:flex lg:fixed lg:left-0 lg:top-0 lg:h-screen lg:w-64 bg-[#081a2f] border-r border-white/10 z-40">
<DrawerMenu />
</aside>
...
<div className="sticky top-0 z-40 border-b border-white/10 bg-[#061226]/95 backdrop-blur-xl">
        <div className="flex items-center justify-between px-4 py-4 md:px-6">
          <button
            onClick={openDrawer}
            className="lg:hidden rounded-xl bg-white/5 border border-white/10 px-4 py-3 text-xl leading-none hover:bg-white/10 transition"
