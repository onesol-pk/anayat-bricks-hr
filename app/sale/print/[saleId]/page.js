  ...
  function Slip({ copyTitle }) {
    ...
    <div className="min-h-screen bg-white text-black p-4">
      <div className="no-print flex justify-between items-center mb-4 max-w-3xl mx-auto">
        <Link href="/sale" className="text-blue-600 underline">Back to Sale</Link>
        <button onClick={handlePrint} className="bg-black text-white px-5 py-2 rounded">Print</button>
      </div>
